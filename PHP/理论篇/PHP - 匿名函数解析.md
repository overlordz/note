...
//结论: 一个舒服的语法必然会受欢迎的.
callback(function() {
    print "This is a anonymous function.".PHP_EOL;
});
...
//结论: 以传值方式传递的基础类型参数, 闭包use的值在闭包创建时就确定了.
$msg = "Hello, everyone";
$callback = function () use ($msg) {
    print "This is a closure use string value, msg is: $msg.".PHP_EOL;
};
$msg = "Hello, everybody";
callback($callback);
...
$msg = "Hello, everyone";
$callback = function () use (&$msg) {
    print "This is a closure use string value lazy bind, msg is: $msg. ".PHP_EOL;
};
$msg = "Hello, everybody";
callback($callback);
...
$callback = function () use ($obj) {
    print "This is a closure use object, msg is: {$obj->scalar}. ".PHP_EOL;
};
...
$obj = (object) "Hello, everyone";
$callback = function () use (&$obj) {
    print "This is a closure use object lazy bind, msg is: {$obj->scalar}. ".PHP_EOL;
};
$obj = (object) "Hello, everybody";
callback($callback);
...
$counter1 = counter();
$counter2 = counter();
echo "counter1: " . $counter1() . PHP_EOL;
echo "counter1: " . $counter1() . PHP_EOL;
echo "counter1: " . $counter1() . PHP_EOL;
echo "counter1: " . $counter1() . PHP_EOL;
echo "counter2: " . $counter2() . PHP_EOL;
echo "counter2: " . $counter2() . PHP_EOL;
echo "counter2: " . $counter2() . PHP_EOL;
echo "counter2: " . $counter2() . PHP_EOL;
```